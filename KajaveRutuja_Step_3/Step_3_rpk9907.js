...
var VSHADER_SOURCE = 
  ...
  'uniform vec2 u_shiver;\n' +   // Initialising the u_shiver uniform vec2
  'attribute vec4 a_Position;\n' +
  'attribute vec4 a_Color;\n' +
  'varying vec4 v_Color;\n' +
  'void main() {\n' +
  '  gl_Position = u_ModelMatrix * a_Position;\n' +
  '  float myWave = u_shiver.x * sin( 0.2 * gl_Position.y + u_shiver.y);\n'+ //Freq = 20
...
var shiver_x = 0.2;  // Init x and y variables for the u_shiver
var shiver_y = 0.0;													// (x,y,z,w)position + (r,g,b)color
...
//==============================================================================
  ...
  modelMatrix.setIdentity();    // DEFINE 'world-space' coords.
	...
	gl.uniform2f(u_shiver, shiver_x, shiver_y);
